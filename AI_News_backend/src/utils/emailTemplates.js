export const generateDigestHTML = (name, articles) => {
  ...
  const articleRows = articles.map(art => `
    <div style="padding: 20px 0; border-bottom: 1px solid #eee;">
      ...
      <a href="${baseUrl}/${art.categorySlug}/${art.slug}" style="font-size: 12px; color: #111; font-weight: 800; text-decoration: none; border-bottom: 2px solid #0055ff; padding-bottom: 2px;">
        READ FULL STORY →
      </a>
    </div>
  `).join('');
