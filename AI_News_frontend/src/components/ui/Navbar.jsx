            ...
            <div className="relative w-full group">
              ...
              {isMobileSearchOpen && (
                <button
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 p-2 text-ink"
                >
                  <X size={24} />
                </button>
              )}
          ...
          {!isMobileSearchOpen && (
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="md:hidden w-12 h-12 flex items-center justify-center border border-border rounded-full"
              >
